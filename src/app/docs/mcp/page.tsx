  ...
  "mcpServers": {
    "unicon": {
      ...
      "args": ["-y", "@webrenew/unicon-mcp-server"]
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-500/20 text-cyan-400 text-sm">3</span>
      ...
      "args": ["-y", "@webrenew/unicon-mcp-server"]
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-cyan-400 font-semibold mb-2">search_icons</h3>
              <p className="text-sm text-muted-foreground mb-3">
            ...
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-cyan-400 font-semibold mb-2">get_icon</h3>
              <p className="text-sm text-muted-foreground mb-3">
            ...
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-cyan-400 font-semibold mb-2">get_multiple_icons</h3>
              <p className="text-sm text-muted-foreground mb-3">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-purple-400 font-semibold mb-2">unicon://sources</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-purple-400 font-semibold mb-2">unicon://categories</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="p-5 rounded-xl border border-border bg-card">
              <h3 className="font-mono text-purple-400 font-semibold mb-2">unicon://stats</h3>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-border bg-card">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                <p>4. Try running manually: <code className="text-cyan-400">npx -y @webrenew/unicon-mcp-server</code></p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-xl border border-border bg-card">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p>1. Verify icon ID format: <code className="text-cyan-400">source:icon-name</code> (all lowercase)</p>
                <p>2. Use <code className="text-cyan-400">search_icons</code> tool first to find the exact ID</p>
                <p>3. Check icon exists at{" "}
                  <a href="https://unicon.webrenew.com" className="text-purple-400 hover:underline">
                    unicon.webrenew.com
                  </a>
                </p>
              </div>
