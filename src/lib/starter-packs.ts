...
const PACK_COLORS: Record<string, PackColorClasses> = {
  ...
  teal: {
    ...
    icon: "text-teal-500/60 dark:text-teal-400/60",
  },
  green: {
    bg: "bg-green-500/5 dark:bg-green-500/10",
    border: "border-green-500/10 dark:border-green-500/20",
    text: "text-green-700 dark:text-green-400",
    icon: "text-green-500/60 dark:text-green-400/60",
  },
  zinc: {
    bg: "bg-zinc-500/5 dark:bg-zinc-500/10",
    border: "border-zinc-500/10 dark:border-zinc-500/20",
    text: "text-zinc-700 dark:text-zinc-400",
    icon: "text-zinc-500/60 dark:text-zinc-400/60",
  },
  purple: {
