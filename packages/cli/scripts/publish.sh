...
# Publish script for @webrenew/unicon
...
echo -e "${GREEN}Publishing @webrenew/unicon CLI${NC}"
echo ""

# Check if we're in the right directory
if [ ! -f "package.json" ]; then
  echo -e "${RED}Error: package.json not found. Run this from packages/cli/${NC}"
  exit 1
fi
...
# Confirm publish
echo ""
echo -e "${YELLOW}Ready to publish @webrenew/unicon@${VERSION}${NC}"
...
# Success
echo ""
echo -e "${GREEN}✓ Successfully published @webrenew/unicon@${VERSION}${NC}"
echo ""
echo "View at: https://www.npmjs.com/package/@webrenew/unicon"
echo "Install with: npx @webrenew/unicon"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "1. Test installation: npx @webrenew/unicon --help"
